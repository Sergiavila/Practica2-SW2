...
/**
 * <p>
 * Clase Java para receta complex type.
 * 
 * <p>
...
@XmlType(name = "receta", propOrder = { "nombreReceta", "ingredientes", "instrucciones" })
public class Receta {
	 ...
	 * 
	 * @return possible object is {@link Receta.Ingredientes }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link Receta.Ingredientes }
	 * 
	 */
	public void setIngredientes(ArrayList<Ingrediente> value) {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "ingrediente" })
	public static class Ingredientes {
		 ...
		 * 
		 * <p>
		 * Objects of the following type(s) are allowed in the list {@link Ingrediente }
		 * 
		 * 
		 */
